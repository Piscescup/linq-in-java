...
public interface BaseEnumerable<T, F_E extends BaseEnumerable<T, F_E>> extends InternalEnumerable<T> {
     ...
     * <h3>Example</h3>
     * <pre>{@code
     * IntEnumerable lengths = words.selectToInt(String::length);
     * }</pre>
     *
    ...
    /**
     * Projects each element to a {@code long} value.
     *
     * <h3>Example</h3>
     * <pre>{@code
     * LongEnumerable sizes = files.selectToLong(File::length);
     * }</pre>
     *
    ...
    /**
     * Projects each element to a {@code double} value.
     *
     * <h3>Example</h3>
     * <pre>{@code
     * DoubleEnumerable scores = results.selectToDouble(Result::score);
     * }</pre>
     *
